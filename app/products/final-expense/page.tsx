...
const ICONS = { Feather, ShieldCheck, HeartPulse } as const;

export default function FinalExpensePage() {
  const data = servicePages.find((p) => p.id === "final-expense")!;
  return (
    <div>
      ...
      <Section title="Key benefits">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.benefits.map((b) => {
            ...
            const ICONS: Record<string, IconCmp> = { Feather, ShieldCheck, HeartPulse };
            const Icon = ICONS[b.icon] ?? Feather;
            return (
      ...
      <Section title="Final Expense Cost Builder">
