...
const ICONS = { HeartPulse, ShieldCheck, Users } as const;

export default function LongTermCarePage() {
  const data = servicePages.find((p) => p.id === "long-term-care")!;
  return (
    <div>
      ...
      <Section title="Key benefits">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.benefits.map((b) => {
            ...
            const ICONS: Record<string, IconCmp> = { HeartPulse, ShieldCheck, Users };
            const Icon = ICONS[b.icon] ?? HeartPulse;
            return (
      ...
      <Section title="Care Plan Projection">
        <LTCProjection />
      </Section>
