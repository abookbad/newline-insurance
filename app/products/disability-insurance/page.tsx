...
const ICONS = { Shield, Calculator, Users } as const;

export default function DisabilityInsurancePage() {
  const data = servicePages.find((p) => p.id === "disability-insurance")!;
  return (
    <div>
      ...
      <Section title="Key benefits">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.benefits.map((b) => {
            ...
            const ICONS: Record<string, IconCmp> = { Shield, Calculator, Users };
      ...
      <Section title="Benefit Estimator">
