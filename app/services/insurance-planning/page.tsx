...
import { Shield, PiggyBank, HeartPulse, Calculator, Activity } from "lucide-react";

const ICONS = { Shield, PiggyBank, HeartPulse, Calculator, Activity } as const;

export default function InsurancePlanningPage() {
  const data = servicePages.find((p) => p.id === "insurance-planning")!;
  return (
    <div>
      ...
      <Section title="Key benefits">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.benefits.map((b) => {
            ...
            const Icon = ICONS[(b.icon as IconKey)] ?? Shield;
            return (
