...
const ICONS = { Calculator, PieChart, ShieldCheck } as const;

export default function TaxStrategyPage() {
  const data = servicePages.find((p) => p.id === "tax-strategy")!;
  return (
    <div>
      ...
      <Section title="Key benefits">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.benefits.map((b) => {
            ...
            const ICONS: Record<string, IconCmp> = { Calculator, PieChart, ShieldCheck };
      ...
      <Section title="Bracket‑Aware Withdrawal Helper">
        <TaxWithdrawalHelper />
      </Section>
