...
export default function InvestmentPlanningPage() {
  const data = servicePages.find((p) => p.id === "investment-planning")!;
  return (
    <div>
      ...
      <Section title="Key benefits">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {data.benefits.map((b) => {
            const ICONS: Record<string, React.ComponentType<React.SVGProps<SVGSVGElement>>> = { PieChart, Calculator, Shield };
